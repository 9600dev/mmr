...
TARGETS = [
    ...
    "trader.simulation.signal_eval.newey_west_variance",
    ...
    "trader.simulation.signal_combine.combined_ic_estimate",
    "trader.data.fundamentals.is_knowable_at",
    "trader.data.fundamentals.latest_known",
