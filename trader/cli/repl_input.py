...
class _ReplInputRenderable:
    """Render the input content."""

    def __init__(self, input: ReplInput, cursor_visible: bool) -> None:
        self.input = input
...
class ReplInput(Widget, can_focus=True):
    DEFAULT_CSS = """
    ReplInput {
        background: $boost;
        color: $text;
    ...
    def __init__(
        ...
        """Initialise the `ReplInput` widget.
    ...
    def render(self) -> RenderableType:
        if not self.value:
            ...
            return placeholder
        return _ReplInputRenderable(self, self._cursor_visible)
